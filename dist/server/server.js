...
//#region node_modules/.pnpm/@tanstack+react-start-server@1.166.40_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@tanstack/react-start-server/dist/esm/StartServer.js
function StartServer(props) {
	return /* @__PURE__ */ jsx(RouterProvider, { router: props.router });
}
//#endregion
//#region node_modules/.pnpm/@tanstack+react-start-server@1.166.40_react-dom@19.2.5_react@19.2.5__react@19.2.5/node_modules/@tanstack/react-start-server/dist/esm/defaultStreamHandler.js
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("./assets/_tanstack-start-manifest_v-Bw8AO4rR.js");
...
async function transformManifestAssets(source, transformFn, _opts) {
	...
	const rootRoute = manifest.routes[rootRouteId$1] = manifest.routes["__root__"] || {};
	rootRoute.assets = rootRoute.assets || [];
		...
		dehydrate: async (opts) => {
			...
			if (manifest) {
				...
				if (opts?.requestAssets?.length) {
					...
					manifestToDehydrate.routes[rootRouteId$1] = {
						...existingRoot,
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./assets/router-CAyDvul_.js"),
		import("./assets/start-C9t9Nps7.js"),
...
//#endregion
//#region node_modules/.pnpm/@tanstack+react-start@1.167.41_react-dom@19.2.5_react@19.2.5__react@19.2.5_vite@8.0.8_@_2951b0c8fc15f752e54570b8abec2a15/node_modules/@tanstack/react-start/dist/plugin/default-entry/server.ts
